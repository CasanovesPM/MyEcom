...
function addVista(){
  ...
  let ArrayOfVistas = [];
  get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios")).then((snapshot) => {
    ...
    update(ref(realdb, "Usuarios/CasanovesMayoristaSanitarios" ),
    {
      zVistas: actVista
...
document.addEventListener('keydown', (event) => {
 if (event.ctrlKey) {
     if (event.keyCode == 65 || event.keyCode == 97) {
         window.location = "epanel-CasanovesMayoristaSanitarios.html";
...
function GetAllCategory() {
   ...
   get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/zCategorias")).then((snapshot) => {
       snapshot.forEach(cat => {
...
function GetAllBrand() {
   ...
   get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/zMarcas")).then((snapshot) => {
       snapshot.forEach(cat => {
...
function GetAllColors() {
   const dbref = ref(realdb);
   get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/zColores/Header")).then((snapshot) => {
       snapshot.forEach(cat => {
   ...
   get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/zColores/ShopList")).then((snapshot) => {
       snapshot.forEach(cat => {
   ...
   get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/zColores/Producto")).then((snapshot) => {
       snapshot.forEach(cat => {
   ...
   get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/zColores/Footer")).then((snapshot) => {
       snapshot.forEach(cat => {
...
function GetAllBanners() {
   const dbref = ref(realdb);
   get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/zBannersHeaderLinks")).then((snapshot) => {
       snapshot.forEach(cat => {
...
function GetFont(){
 ...
 get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/zFuente")).then((snapshot) => {
       snapshot.forEach(cat => {
...
if (typeof document.getElementById('btnImgPrincipal') === "object" && document.getElementById('btnImgPrincipal') !== null) {
  ...
  if (typeof document.getElementById('btnImgSecundarias') === "object" && document.getElementById('btnImgSecundarias') !== null) {
      ...
      if (typeof document.getElementById('searchInput') === "object" && document.getElementById('searchInput') !== null) {
        ...
        get(child(dbref, "Usuarios/CasanovesMayoristaSanitarios/Productos")).then((snapshot) => {
              snapshot.forEach(cat => {
      ...
      if (typeof document.getElementById('typePago') === "object" && document.getElementById('typePago') !== null) {
        ...
        enviarAWhats.addEventListener('click', function(){
          ...
          update(ref(realdb, "Usuarios/CasanovesMayoristaSanitarios/zPedidos/" + totalNroPedidos ),
          {
      ...
      enviarPedido.addEventListener('click',  async function(){
            ...
            canvas.toBlob(async (blob) => {
              ...
              const ImageAdress = "TheImages/CasanovesMayoristaSanitarios/Pedidos/" + totalNroPedidos;
